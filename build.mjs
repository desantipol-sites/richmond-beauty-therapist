...
<main id="main">
  <section class="hero home-hero">
    <div class="hero-copy"><p class="eyebrow">Richmond Beauty Therapist</p><h1>Welcome to my intimate nail salon.<br><em>Professional care, personally delivered.</em></h1><p class="hero-intro">I offer manicure, pedicure, HEMA- and TPO-free gel polish, lash lift, IBX and KART treatments, using high-quality products and giving every appointment my full attention.</p><div class="button-row"><a class="button" href="${booking}" data-book>Book an appointment</a><a class="text-link" href="#services">See treatments</a></div></div>
