...
<main id="main">
  <section class="hero home-hero">
    <div class="hero-copy"><p class="eyebrow">Richmond Nail Technician</p><h1>Welcome to my intimate nail salon.<br><em>Professional care, personally delivered.</em></h1><p class="hero-intro">I offer manicure, pedicure, <strong>HEMA- and TPO-free</strong> gel polish, lash lift, IBX and KART treatments, using high-quality products. As a <strong>Certified Foot Health Professional</strong>, I take pride in maintaining professional standards while making every visit personal and memorable.</p><div class="button-row"><a class="button" href="${booking}" data-book>Book an appointment</a></div></div>
